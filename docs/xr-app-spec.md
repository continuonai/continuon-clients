...
- gRPC/WebRTC link to PixelBrain/OS (mock allowed in Phase 1).
...
- **PixelBrainClient:** gRPC/WebRTC for robot state + command streaming.
...
- Simulated PixelBrain/OS service to replay robot state and accept commands.
