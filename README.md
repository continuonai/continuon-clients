...
* [`docs/deployment-path.md`](docs/deployment-path.md) — XR capture → RLDS curation → cloud training/export → signed bundle → OTA → Memory Plane merge/rollback
...
See `continuonbrain/README.md` and `continuonbrain/PI5_EDGE_BRAIN_INSTRUCTIONS.md` for the current Pi runbook. (`continuonbrain/PI5_CAR_READINESS.md` is kept as a short redirect.)
