...
Trainer note: the mock service is for XR-side contract testing only. Offline LoRA adapter training lives in `continuonbrain/trainer/` scaffolding and should be run on Pi/Jetson hardware, not in this mock.
