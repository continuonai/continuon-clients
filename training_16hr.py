...
LOG_FILE = Path("/home/craigm26/Downloads/ContinuonXR/training_16hr_log.jsonl")
DURATION_HOURS = 16
...
def main():
    print("=" * 60)
    print("  16-HOUR EXTENDED TRAINING SESSION")
    ...
    print(f"\n{'='*60}")
    print("  16-HOUR TRAINING SESSION COMPLETE!")
